  ...
  return (
    <Flex className="middleBanner">
      ...
      <Flex className="middleBanner-content">
        <Heading>
          Acessórios Pet na ChikPet: Estilo e Conforto em Cada Detalhe!
        </Heading>
        <Text>
          Descubra a coleção exclusiva de acessórios para pets na ChikPet. De
          coleiras deslumbrantes a caminhas aconchegantes, ofereça ao seu
          companheiro peludo um toque de estilo e conforto. Explore agora!
        </Text>
      </Flex>
    </Flex>
  );
